...
Module['FS_createPath']("/", "assets", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/README.md", "start": 0, "end": 163}, {"filename": "/assets/long_cat.png", "start": 163, "end": 346}, {"filename": "/assets/round_cat.png", "start": 346, "end": 663}], "remote_package_size": 663});

  })();

// end include: /tmp/tmpqxc1idvq.js
// include: /tmp/tmpz0n1np6t.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpz0n1np6t.js
// include: /tmp/tmptd4_mz4h.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmptd4_mz4h.js
...
var ASM_CONSTS = {
  134446: () => { if (document.fullscreenElement) return 1; },  
 134492: () => { return Module.canvas.width; },  
 134524: () => { return parseInt(Module.canvas.style.width); },  
 134572: () => { document.exitFullscreen(); },  
 134599: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 134671: () => { if (document.fullscreenElement) return 1; },  
 134717: () => { return Module.canvas.width; },  
 134749: () => { return screen.width; },  
 134774: () => { document.exitFullscreen(); },  
 134801: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 134995: () => { return window.innerWidth; },  
 135021: () => { return window.innerHeight; },  
 135048: () => { if (document.fullscreenElement) return 1; },  
 135094: () => { return Module.canvas.width; },  
 135126: () => { return parseInt(Module.canvas.style.width); },  
 135174: () => { if (document.fullscreenElement) return 1; },  
 135220: () => { return Module.canvas.width; },  
 135252: () => { return screen.width; },  
 135277: () => { return window.innerWidth; },  
 135303: () => { return window.innerHeight; },  
 135330: () => { if (document.fullscreenElement) return 1; },  
 135376: () => { return Module.canvas.width; },  
 135408: () => { return screen.width; },  
 135433: () => { document.exitFullscreen(); },  
 135460: () => { if (document.fullscreenElement) return 1; },  
 135506: () => { return Module.canvas.width; },  
 135538: () => { return parseInt(Module.canvas.style.width); },  
 135586: () => { document.exitFullscreen(); },  
 135613: ($0) => { Module.canvas.style.opacity = $0; },  
 135651: () => { return screen.width; },  
 135676: () => { return screen.height; },  
 135702: () => { return window.screenX; },  
 135729: () => { return window.screenY; },  
 135756: () => { return window.devicePixelRatio; },  
 135792: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 135845: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 135896: () => { Module.canvas.style.cursor = 'none'; },  
 135933: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 136189: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 136240: () => { if (document.pointerLockElement) return 1; },  
 136287: () => { if (document.fullscreenElement) return 1; },  
 136333: () => { return window.innerWidth; },  
 136359: () => { return window.innerHeight; }
};
...
function assignWasmExports(wasmExports) {
  ...
  _default_context_ptr = Module['_default_context_ptr'] = createExportWrapper('default_context_ptr', wasmExports['default_context_ptr'], 0);
  _main_start = Module['_main_start'] = createExportWrapper('main_start', wasmExports['main_start'], 0);
  __start = Module['__start'] = createExportWrapper('_start', wasmExports['_start'], 0);
  __end = Module['__end'] = createExportWrapper('_end', wasmExports['_end'], 0);
  _main_update = Module['_main_update'] = createExportWrapper('main_update', wasmExports['main_update'], 0);
  _main_end = Module['_main_end'] = createExportWrapper('main_end', wasmExports['main_end'], 0);
  _web_window_size_changed = Module['_web_window_size_changed'] = createExportWrapper('web_window_size_changed', wasmExports['web_window_size_changed'], 2);
